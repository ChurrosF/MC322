...
import States.RenderHandler;
import States.StateType;

public class BattleRenderHandler extends RenderHandler {
    private final int HEIGHT = TerminalManager.getInstance().getHeight();
    private final int WIDTH = TerminalManager.getInstance().getWidth();
    ...
    public BattleRenderHandler(TextGraphics textGraphics, StateType type) {
        super(textGraphics);
        this.type = type;
    }
